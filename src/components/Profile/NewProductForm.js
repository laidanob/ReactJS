...
export const NewProductForm = ({initialValues,handleEnviar}) => {
  ...
  return (
    <Formik 
            ...
            onSubmit={(valores,resetForm) => {handleEnviar(valores,resetForm)}} >
                     ...
                     <TextField
                        ...
                        />
                         ...
                         <TextField
                            ...
                            name="precio"
                            onBlur={formik.handleBlur}
                            error={formik.touched.precio && formik.errors.precio ? true : false}
                        ...
                        <Select
                                ...
                                label="Categoria"
                                error={formik.touched.categoria && formik.errors.categoria ? true : false}
                            ...
                            <MenuItem disabled value={""}>Seleccionar Categoria</MenuItem>
