...
export const NavBarMenu = (handleCloseUserMenu) => {
  ...
  return (<>
            <MenuItem className={"boton"}   key={"nosotros"} >
                <Link component={Link}  to="/"> <Typography color={(ruta == "/") ? "primary.main" : ""} sx={{ '&:hover': { color: "primary.main"} }} textAlign="center">SOBRE RABBIT</Typography></Link>
            </MenuItem>

            <MenuItem  key={"fotolibros"} >
                <Link component={Link}  to="/productos" > <Typography color={(ruta == "/fotolibros") ? "primary.main" : ""} sx={{'&:hover': { color: "primary.main"}}} textAlign="center">FOTOLIBROS</Typography></Link>
            </MenuItem>
